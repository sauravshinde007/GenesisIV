...
public class WallRunning : MonoBehaviour
{
    ...
    {
        if (!pm.wallrunning) return; // Prevent redundant calls

        pm.wallrunning = false;

        // Reset camera effects once
        cam.DoFov(80f);
        cam.DoTilt(0f);
    }
    ...
    private void WallJump()
    {
        ...
        Vector3 forceToApply = transform.up * wallJumpUpForce + wallNormal * wallJumpSideForce+ orientation.forward * 5f;;
